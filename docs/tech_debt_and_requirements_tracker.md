...
| FU-004 | **$500 Early Dollar Stop is net harmful as configured** | Standalone replay shows −$3,240 on winners (CPAY, DXCM) while its loser saves are already captured a day earlier by the day-0 kill-switch. All-in stack net: shipped ($500) −$272, versus +$3,027 at $1,500 or with the rule removed. Contradicts `decisions/2026-08-18_early-dollar-stop.md` (+$2,936), which predates the kill-switch tightening. **Leading candidate: raise `EARLY_DOLLAR_STOP_AMOUNT` to `1500`** — strictly dominant over $500 in the sample (identical loser outcomes, zero winner damage, catastrophic cap retained). | First scheduled review, 2026-09-20 | Open |
