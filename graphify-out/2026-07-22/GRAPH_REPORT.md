...
## Summary
- 1155 nodes · 1868 edges · 87 communities (58 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.63)
- Token cost: 6,552 input · 1,010 output
...
## Knowledge Gaps
- **199 isolated node(s):** `Overview � Two-Stage Pipeline`, `1.1 What Happens Every Evening`, `Endpoint`, `Equivalent TradingView Screener URL (manual verification)`, `Full Request Payload (exact)` (+194 more)
...
- **Why does `_compute_dynamic_trail_pct()` connect `Dynamic Trailing Stop Logic` to `Technical Analysis Indicators`, `Intraday Monitoring Daemon`?**
...
- **What connects `Overview � Two-Stage Pipeline`, `1.1 What Happens Every Evening`, `Endpoint` to the rest of the system?**
