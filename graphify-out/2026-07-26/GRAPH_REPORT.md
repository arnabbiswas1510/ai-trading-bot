...
Cohesion: 0.25
Nodes (7): 1. Dynamic Trailing Stop Loss (IBKR-Managed), 2. Day 3 Breakout Verdict & Intraday Loss Minimiser (Day 4+), 3. Moving Average Support Breach (Day 7+ EOD), Active Exit Mechanisms, Legacy / Manual Scripts, Overview, Sell Logic
