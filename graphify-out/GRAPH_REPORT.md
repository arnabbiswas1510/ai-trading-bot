# Graph Report - ai-trading-bot  (2026-08-21)

## Corpus Check
- 175 files · ~254,582 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2736 nodes · 4323 edges · 258 communities (243 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23c44873`
...
Cohesion: 0.06
Nodes (40): calculate_ema(), calculate_sma(), check_volume_distribution(), compute_momentum_health_score(), compute_rsi(), detect_candlestick_reversals(), early_dollar_stop_threshold(), fetch_held_position_sentiment() (+32 more)
...
### Community 206 - "fetch_ibkr_delayed_price"
Cohesion: 0.22
Nodes (17): fetch_ibkr_delayed_price(), get_live_price(), Fetch the current price for a contract using IBKR delayed market data (type 3)., Fetch current price of a ticker from FMP., archive(), cancel_sells(), current_price(), main() (+9 more)
...
Cohesion: 0.18
Nodes (13): place_oca_exit(), Places the OCA exit pair on an open position:          upper leg  LMT  SELL @ li, Factory for IBKR TRAIL order type.     `ib_insync` 0.9.x does not export a Trail, TrailingStopOrder(), get_ibkr_price(), main(), _place_buy(), IB (+5 more)
...
### Community 239 - "maybe_arm_power_hold"
Cohesion: 0.22
...
Cohesion: 0.10
Nodes (43): arm_exit(), cancel_ticker_sell_orders(), execute_sell(), _fetch_current_rs(), get_available_cash(), _get_entry_rs(), get_ibkr_account(), get_margin_loan() (+35 more)
...
Cohesion: 0.50
Nodes (3): Give a mock IB an account with readable NetLiquidation.      The Early Dollar St, TestLadderSuspension, _with_equity()
...
## Knowledge Gaps
- **824 isolated node(s):** `bar_interval`, `bytes`, `dataset`, `date_max`, `date_min` (+819 more)
